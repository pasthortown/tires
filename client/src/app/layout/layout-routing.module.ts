...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'cliente', loadChildren: './CRUD/cliente/cliente.module#ClienteModule' },
            ...
            { path: 'paisorigen', loadChildren: './CRUD/paisorigen/paisorigen.module#PaisOrigenModule' },
            ...
            { path: 'tipolabrado', loadChildren: './CRUD/tipolabrado/tipolabrado.module#TipoLabradoModule' },
