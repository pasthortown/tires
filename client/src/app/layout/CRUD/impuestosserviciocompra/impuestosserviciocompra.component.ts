...
@Component({
   selector: 'app-impuestosserviciocompra',
   templateUrl: './impuestosserviciocompra.component.html',
   styleUrls: ['./impuestosserviciocompra.component.scss']
})

export class ImpuestosServicioCompraComponent implements OnInit {

   busy: Promise<any>;
   entidades: ImpuestosServicioCompra[];
   entidadSeleccionada: ImpuestosServicioCompra;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ImpuestosServicioCompraService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ImpuestosServicioCompra): boolean {
      return true;
   }
   ...
   crearEntidad(): ImpuestosServicioCompra {
      const nuevoImpuestosServicioCompra = new ImpuestosServicioCompra();
      nuevoImpuestosServicioCompra.id = 0;
      return nuevoImpuestosServicioCompra;
   }

   add(entidadNueva: ImpuestosServicioCompra): void {
   ...
   update(entidadParaActualizar: ImpuestosServicioCompra): void {
   ...
   delete(entidadParaBorrar: ImpuestosServicioCompra): void {
   ...
   refresh(): void {
      ...
      this.entidades = ImpuestosServicioCompra[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ImpuestosServicioCompra): void {
