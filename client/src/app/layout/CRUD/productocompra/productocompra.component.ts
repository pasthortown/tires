...
@Component({
   ...
   styleUrls: ['./productocompra.component.scss']
})

export class ProductoCompraComponent implements OnInit {

   busy: Promise<any>;
   entidades: ProductoCompra[];
   entidadSeleccionada: ProductoCompra;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ProductoCompraService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ProductoCompra): boolean {
      return true;
   }
   ...
   crearEntidad(): ProductoCompra {
      const nuevoProductoCompra = new ProductoCompra();
      nuevoProductoCompra.id = 0;
      return nuevoProductoCompra;
   }

   add(entidadNueva: ProductoCompra): void {
   ...
   update(entidadParaActualizar: ProductoCompra): void {
   ...
   delete(entidadParaBorrar: ProductoCompra): void {
   ...
   refresh(): void {
      ...
      this.entidades = ProductoCompra[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ProductoCompra): void {
