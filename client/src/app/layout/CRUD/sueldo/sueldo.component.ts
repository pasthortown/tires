...
export class SueldoComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SueldoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Sueldo): boolean {
      return true;
   }
   ...
   crearEntidad(): Sueldo {
      const nuevoSueldo = new Sueldo();
      nuevoSueldo.id = 0;
      return nuevoSueldo;
   }

   add(entidadNueva: Sueldo): void {
   ...
   update(entidadParaActualizar: Sueldo): void {
   ...
   delete(entidadParaBorrar: Sueldo): void {
   ...
   onSelect(entidadActual: Sueldo): void {
