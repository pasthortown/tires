...
@Component({
   selector: 'app-impuestosservicioventa',
   templateUrl: './impuestosservicioventa.component.html',
   styleUrls: ['./impuestosservicioventa.component.scss']
})

export class ImpuestosServicioVentaComponent implements OnInit {

   busy: Promise<any>;
   entidades: ImpuestosServicioVenta[];
   entidadSeleccionada: ImpuestosServicioVenta;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ImpuestosServicioVentaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ImpuestosServicioVenta): boolean {
      return true;
   }
   ...
   crearEntidad(): ImpuestosServicioVenta {
      const nuevoImpuestosServicioVenta = new ImpuestosServicioVenta();
      nuevoImpuestosServicioVenta.id = 0;
      return nuevoImpuestosServicioVenta;
   }

   add(entidadNueva: ImpuestosServicioVenta): void {
   ...
   update(entidadParaActualizar: ImpuestosServicioVenta): void {
   ...
   delete(entidadParaBorrar: ImpuestosServicioVenta): void {
   ...
   refresh(): void {
      ...
      this.entidades = ImpuestosServicioVenta[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ImpuestosServicioVenta): void {
