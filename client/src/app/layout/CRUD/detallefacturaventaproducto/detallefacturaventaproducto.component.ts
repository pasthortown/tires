...
@Component({
   selector: 'app-detallefacturaventaproducto',
   templateUrl: './detallefacturaventaproducto.component.html',
   styleUrls: ['./detallefacturaventaproducto.component.scss']
})

export class DetalleFacturaVentaProductoComponent implements OnInit {

   busy: Promise<any>;
   entidades: DetalleFacturaVentaProducto[];
   entidadSeleccionada: DetalleFacturaVentaProducto;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DetalleFacturaVentaProductoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DetalleFacturaVentaProducto): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleFacturaVentaProducto {
      const nuevoDetalleFacturaVentaProducto = new DetalleFacturaVentaProducto();
      nuevoDetalleFacturaVentaProducto.id = 0;
      return nuevoDetalleFacturaVentaProducto;
   }

   add(entidadNueva: DetalleFacturaVentaProducto): void {
   ...
   update(entidadParaActualizar: DetalleFacturaVentaProducto): void {
   ...
   delete(entidadParaBorrar: DetalleFacturaVentaProducto): void {
   ...
   refresh(): void {
      ...
      this.entidades = DetalleFacturaVentaProducto[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DetalleFacturaVentaProducto): void {
