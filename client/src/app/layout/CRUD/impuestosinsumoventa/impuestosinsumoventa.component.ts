...
@Component({
   selector: 'app-impuestosinsumoventa',
   templateUrl: './impuestosinsumoventa.component.html',
   styleUrls: ['./impuestosinsumoventa.component.scss']
})

export class ImpuestosInsumoVentaComponent implements OnInit {

   busy: Promise<any>;
   entidades: ImpuestosInsumoVenta[];
   entidadSeleccionada: ImpuestosInsumoVenta;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ImpuestosInsumoVentaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ImpuestosInsumoVenta): boolean {
      return true;
   }
   ...
   crearEntidad(): ImpuestosInsumoVenta {
      const nuevoImpuestosInsumoVenta = new ImpuestosInsumoVenta();
      nuevoImpuestosInsumoVenta.id = 0;
      return nuevoImpuestosInsumoVenta;
   }

   add(entidadNueva: ImpuestosInsumoVenta): void {
   ...
   update(entidadParaActualizar: ImpuestosInsumoVenta): void {
   ...
   delete(entidadParaBorrar: ImpuestosInsumoVenta): void {
   ...
   refresh(): void {
      ...
      this.entidades = ImpuestosInsumoVenta[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ImpuestosInsumoVenta): void {
