...
@Component({
   selector: 'app-detallefacturacompraproducto',
   templateUrl: './detallefacturacompraproducto.component.html',
   styleUrls: ['./detallefacturacompraproducto.component.scss']
})

export class DetalleFacturaCompraProductoComponent implements OnInit {

   busy: Promise<any>;
   entidades: DetalleFacturaCompraProducto[];
   entidadSeleccionada: DetalleFacturaCompraProducto;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DetalleFacturaCompraProductoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DetalleFacturaCompraProducto): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleFacturaCompraProducto {
      const nuevoDetalleFacturaCompraProducto = new DetalleFacturaCompraProducto();
      nuevoDetalleFacturaCompraProducto.id = 0;
      return nuevoDetalleFacturaCompraProducto;
   }

   add(entidadNueva: DetalleFacturaCompraProducto): void {
   ...
   update(entidadParaActualizar: DetalleFacturaCompraProducto): void {
   ...
   delete(entidadParaBorrar: DetalleFacturaCompraProducto): void {
   ...
   refresh(): void {
      ...
      this.entidades = DetalleFacturaCompraProducto[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DetalleFacturaCompraProducto): void {
