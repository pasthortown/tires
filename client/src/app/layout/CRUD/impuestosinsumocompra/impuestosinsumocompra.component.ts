...
@Component({
   selector: 'app-impuestosinsumocompra',
   templateUrl: './impuestosinsumocompra.component.html',
   styleUrls: ['./impuestosinsumocompra.component.scss']
})

export class ImpuestosInsumoCompraComponent implements OnInit {

   busy: Promise<any>;
   entidades: ImpuestosInsumoCompra[];
   entidadSeleccionada: ImpuestosInsumoCompra;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ImpuestosInsumoCompraService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ImpuestosInsumoCompra): boolean {
      return true;
   }
   ...
   crearEntidad(): ImpuestosInsumoCompra {
      const nuevoImpuestosInsumoCompra = new ImpuestosInsumoCompra();
      nuevoImpuestosInsumoCompra.id = 0;
      return nuevoImpuestosInsumoCompra;
   }

   add(entidadNueva: ImpuestosInsumoCompra): void {
   ...
   update(entidadParaActualizar: ImpuestosInsumoCompra): void {
   ...
   delete(entidadParaBorrar: ImpuestosInsumoCompra): void {
   ...
   refresh(): void {
      ...
      this.entidades = ImpuestosInsumoCompra[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ImpuestosInsumoCompra): void {
