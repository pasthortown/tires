...
@Component({
   selector: 'app-impuestosproductoventa',
   templateUrl: './impuestosproductoventa.component.html',
   styleUrls: ['./impuestosproductoventa.component.scss']
})

export class ImpuestosProductoVentaComponent implements OnInit {

   busy: Promise<any>;
   entidades: ImpuestosProductoVenta[];
   entidadSeleccionada: ImpuestosProductoVenta;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ImpuestosProductoVentaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ImpuestosProductoVenta): boolean {
      return true;
   }
   ...
   crearEntidad(): ImpuestosProductoVenta {
      const nuevoImpuestosProductoVenta = new ImpuestosProductoVenta();
      nuevoImpuestosProductoVenta.id = 0;
      return nuevoImpuestosProductoVenta;
   }

   add(entidadNueva: ImpuestosProductoVenta): void {
   ...
   update(entidadParaActualizar: ImpuestosProductoVenta): void {
   ...
   delete(entidadParaBorrar: ImpuestosProductoVenta): void {
   ...
   refresh(): void {
      ...
      this.entidades = ImpuestosProductoVenta[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ImpuestosProductoVenta): void {
