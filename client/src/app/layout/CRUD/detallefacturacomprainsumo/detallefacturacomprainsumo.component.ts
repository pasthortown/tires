...
@Component({
   selector: 'app-detallefacturacomprainsumo',
   templateUrl: './detallefacturacomprainsumo.component.html',
   styleUrls: ['./detallefacturacomprainsumo.component.scss']
})

export class DetalleFacturaCompraInsumoComponent implements OnInit {

   busy: Promise<any>;
   entidades: DetalleFacturaCompraInsumo[];
   entidadSeleccionada: DetalleFacturaCompraInsumo;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DetalleFacturaCompraInsumoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DetalleFacturaCompraInsumo): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleFacturaCompraInsumo {
      const nuevoDetalleFacturaCompraInsumo = new DetalleFacturaCompraInsumo();
      nuevoDetalleFacturaCompraInsumo.id = 0;
      return nuevoDetalleFacturaCompraInsumo;
   }

   add(entidadNueva: DetalleFacturaCompraInsumo): void {
   ...
   update(entidadParaActualizar: DetalleFacturaCompraInsumo): void {
   ...
   delete(entidadParaBorrar: DetalleFacturaCompraInsumo): void {
   ...
   refresh(): void {
      ...
      this.entidades = DetalleFacturaCompraInsumo[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DetalleFacturaCompraInsumo): void {
