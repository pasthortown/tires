...
@Component({
   selector: 'app-detallefacturaventainsumo',
   templateUrl: './detallefacturaventainsumo.component.html',
   styleUrls: ['./detallefacturaventainsumo.component.scss']
})

export class DetalleFacturaVentaInsumoComponent implements OnInit {

   busy: Promise<any>;
   entidades: DetalleFacturaVentaInsumo[];
   entidadSeleccionada: DetalleFacturaVentaInsumo;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DetalleFacturaVentaInsumoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DetalleFacturaVentaInsumo): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleFacturaVentaInsumo {
      const nuevoDetalleFacturaVentaInsumo = new DetalleFacturaVentaInsumo();
      nuevoDetalleFacturaVentaInsumo.id = 0;
      return nuevoDetalleFacturaVentaInsumo;
   }

   add(entidadNueva: DetalleFacturaVentaInsumo): void {
   ...
   update(entidadParaActualizar: DetalleFacturaVentaInsumo): void {
   ...
   delete(entidadParaBorrar: DetalleFacturaVentaInsumo): void {
   ...
   refresh(): void {
      ...
      this.entidades = DetalleFacturaVentaInsumo[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DetalleFacturaVentaInsumo): void {
