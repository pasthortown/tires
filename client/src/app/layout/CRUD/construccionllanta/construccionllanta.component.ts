...
@Component({
   selector: 'app-construccionllanta',
   templateUrl: './construccionllanta.component.html',
   styleUrls: ['./construccionllanta.component.scss']
})

export class ConstruccionLlantaComponent implements OnInit {

   busy: Promise<any>;
   entidades: ConstruccionLlanta[];
   entidadSeleccionada: ConstruccionLlanta;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ConstruccionLlantaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ConstruccionLlanta): boolean {
      return true;
   }
   ...
   crearEntidad(): ConstruccionLlanta {
      const nuevoConstruccionLlanta = new ConstruccionLlanta();
      nuevoConstruccionLlanta.id = 0;
      return nuevoConstruccionLlanta;
   }

   add(entidadNueva: ConstruccionLlanta): void {
   ...
   update(entidadParaActualizar: ConstruccionLlanta): void {
   ...
   delete(entidadParaBorrar: ConstruccionLlanta): void {
   ...
   refresh(): void {
      ...
      this.entidades = ConstruccionLlanta[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ConstruccionLlanta): void {
