...
@Component({
   selector: 'app-detallefacturacompraservicio',
   templateUrl: './detallefacturacompraservicio.component.html',
   styleUrls: ['./detallefacturacompraservicio.component.scss']
})

export class DetalleFacturaCompraServicioComponent implements OnInit {

   busy: Promise<any>;
   entidades: DetalleFacturaCompraServicio[];
   entidadSeleccionada: DetalleFacturaCompraServicio;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DetalleFacturaCompraServicioService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DetalleFacturaCompraServicio): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleFacturaCompraServicio {
      const nuevoDetalleFacturaCompraServicio = new DetalleFacturaCompraServicio();
      nuevoDetalleFacturaCompraServicio.id = 0;
      return nuevoDetalleFacturaCompraServicio;
   }

   add(entidadNueva: DetalleFacturaCompraServicio): void {
   ...
   update(entidadParaActualizar: DetalleFacturaCompraServicio): void {
   ...
   delete(entidadParaBorrar: DetalleFacturaCompraServicio): void {
   ...
   refresh(): void {
      ...
      this.entidades = DetalleFacturaCompraServicio[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DetalleFacturaCompraServicio): void {
