...
@Component({
   selector: 'app-detallefacturaventaservicio',
   templateUrl: './detallefacturaventaservicio.component.html',
   styleUrls: ['./detallefacturaventaservicio.component.scss']
})

export class DetalleFacturaVentaServicioComponent implements OnInit {

   busy: Promise<any>;
   entidades: DetalleFacturaVentaServicio[];
   entidadSeleccionada: DetalleFacturaVentaServicio;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DetalleFacturaVentaServicioService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DetalleFacturaVentaServicio): boolean {
      return true;
   }
   ...
   crearEntidad(): DetalleFacturaVentaServicio {
      const nuevoDetalleFacturaVentaServicio = new DetalleFacturaVentaServicio();
      nuevoDetalleFacturaVentaServicio.id = 0;
      return nuevoDetalleFacturaVentaServicio;
   }

   add(entidadNueva: DetalleFacturaVentaServicio): void {
   ...
   update(entidadParaActualizar: DetalleFacturaVentaServicio): void {
   ...
   delete(entidadParaBorrar: DetalleFacturaVentaServicio): void {
   ...
   refresh(): void {
      ...
      this.entidades = DetalleFacturaVentaServicio[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DetalleFacturaVentaServicio): void {
