...
@Component({
   selector: 'app-impuestosproductocompra',
   templateUrl: './impuestosproductocompra.component.html',
   styleUrls: ['./impuestosproductocompra.component.scss']
})

export class ImpuestosProductoCompraComponent implements OnInit {

   busy: Promise<any>;
   entidades: ImpuestosProductoCompra[];
   entidadSeleccionada: ImpuestosProductoCompra;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ImpuestosProductoCompraService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ImpuestosProductoCompra): boolean {
      return true;
   }
   ...
   crearEntidad(): ImpuestosProductoCompra {
      const nuevoImpuestosProductoCompra = new ImpuestosProductoCompra();
      nuevoImpuestosProductoCompra.id = 0;
      return nuevoImpuestosProductoCompra;
   }

   add(entidadNueva: ImpuestosProductoCompra): void {
   ...
   update(entidadParaActualizar: ImpuestosProductoCompra): void {
   ...
   delete(entidadParaBorrar: ImpuestosProductoCompra): void {
   ...
   refresh(): void {
      ...
      this.entidades = ImpuestosProductoCompra[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ImpuestosProductoCompra): void {
