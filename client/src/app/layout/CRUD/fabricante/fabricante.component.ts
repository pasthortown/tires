...
export class FabricanteComponent implements OnInit {
   ...
   entidadSeleccionada: Fabricante;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: FabricanteService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Fabricante): boolean {
      return true;
   }
   ...
   crearEntidad(): Fabricante {
      const nuevoFabricante = new Fabricante();
      nuevoFabricante.id = 0;
      return nuevoFabricante;
   }

   add(entidadNueva: Fabricante): void {
   ...
   update(entidadParaActualizar: Fabricante): void {
   ...
   delete(entidadParaBorrar: Fabricante): void {
   ...
   onSelect(entidadActual: Fabricante): void {
